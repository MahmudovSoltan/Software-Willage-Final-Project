  ...
  return (
    <div>
      ...
      <div className="aboutUs-company">
          ...
          <div className="mission_left">
            <Fade direction="left" triggerOnce="true" duration={2500}>
              <div className="misson_img">
                <img
                  src="https://coaching.thimpress.com/business-consulting/wp-content/uploads/sites/52/2024/03/about-us-02.jpg"
                  alt="misson_img"
                />
              </div>
            </Fade>
          ...
          <div className="mission_right">
            <Fade direction="right" triggerOnce="true" duration={2500}>
              <div className="mission_info">
                ...
                <p className="mission-paraqraf">
                  Through gaining experience in various economic periods, our
                  team are able to identify the best opportunities whether we
                  are in good times or bad times. Good times provide growth in
                  our portfolio and bad times, despite the potential negative
                  effects, can provide opportunities.
                </p>
        ...
        <div className="aboutUs-mission">
          <div className="aboutus-mission_left">
            <Fade direction="left" triggerOnce="true" duration={2500}>
              <div className="mission_info">
          ...
          <div className="aboutus-mission_right">
            <Fade direction="right" triggerOnce="true" duration={2500}>
              <div className="misson_img">
                <img
                  src="https://coaching.thimpress.com/business-consulting/wp-content/uploads/sites/52/2024/03/about-us-03.jpg"
                  alt="mission-2-img"
                />
              </div>
            </Fade>
      ...
      <section className="mission-slider-section">
        <div className="mission-slider-title">
          <div className="mission_title">OUR MEDIA</div>
          <h3 className="mission-header">Our Company On Media Show</h3>
        </div>
            ...
            <Slider {...settings}>
              <div className="mission-slider">
                <img
                  ...
                  src="https://coaching.thimpress.com/business-consulting/wp-content/uploads/sites/52/2023/06/blog-09-820x430.jpg"
                  alt="image-3"
                />
                <div className="slider-container-bottom">
                  <span className="span-line">Blog</span>
                  <span className="span-date">Janury 20,2022</span>
                </div>
              ...
              <div className="mission-slider">
                <img
                  className="mission-img"
                  src="https://coaching.thimpress.com/business-consulting/wp-content/uploads/sites/52/2023/06/blog-08-820x430.jpg"
                  alt="image-4"
                />
                <div className="slider-container-bottom">
                  <span className="span-line">Blog</span>
                ...
                <h6 className="slider-title">
                  What the pro-business tax agenda is chasing in a changing
                  Congress
                </h6>
                <p className="span-date">
                  It is a long established fact that a reader will be distracted
              ...
              <div className="mission-slider">
                <img
                  className="mission-img"
                  src="https://coaching.thimpress.com/business-consulting/wp-content/uploads/sites/52/2023/06/blog-06-820x430.jpg"
                  alt="image-5"
                />
                <div className="slider-container-bottom">
                  <span className="span-line">Blog</span>
              ...
              <div className="mission-slider">
                <img
                  className="mission-img"
                  src="https://coaching.thimpress.com/business-consulting/wp-content/uploads/sites/52/2023/06/blog-05-820x430.jpg"
                  alt="image-6"
                />
                <div className="slider-container-bottom">
                  <span className="span-line">Blog</span>
                ...
                <h6 className="slider-title">
                  Inflation? Recession? Starting Black Friday, Americans say
      ...
      <section className="choose-section">
        <div className="choose-items">
          <div className="choose-item-left">
            <img
              src="https://coaching.thimpress.com/business-consulting/wp-content/uploads/sites/52/2024/03/about-us-faqs.jpg"
              alt="image-3"
            />
          </div>
          <div className="choose-item-right">
            <div className="mission_title">WHY CHOOSE US?</div>
            ...
            <div className="choose-manual-items">
              <div className="choose-manual-item" onClick={changetext}>
                <span>{text ? <HiMinus /> : <IoIosAdd />}</span>
                <strong>Unique Brand Identity And Strategy</strong>
              </div>
            ...
            <div className="choose-manual-items">
              <div className="choose-manual-item" onClick={changetext1}>
                <span>{text1 ? <HiMinus /> : <IoIosAdd />}</span>
                <strong>Unique Brand Identity And Strategy</strong>
              </div>
            ...
            <div className="choose-manual-items">
              <div className="choose-manual-item" onClick={changetext2}>
                <span>{text2 ? <HiMinus /> : <IoIosAdd />}</span>
                <strong>Unique Brand Identity And Strategy</strong>
              </div>
