  ...
  return (
    <div>
      ...
      <div className="slide_side">
        <div className="slideside_left_item">
        <Fade direction="left" triggerOnce="true" duration={2500}>
          <div className="slideside_left">
            <img
              src="	https://coaching.thimpress.com/business-consulting/wp-content/uploads/sites/52/2024/03/service-1.jpg"
              alt="left_img"
            />
          </div>
        </Fade>
        </div>
        <div className="slideside_right_item">
          ...
          <div className="slideside_right">
            ...
            <div className="right_paraqraf">
              <p>
                ...
                tellus at urna condimentum. Aliquam malesuadan bibendum arcu
                vitae elementum. Eget duis at tellus urna mentum aliqua.
              </p>
            ...
            <div className="right_buttom">
              <div className="right_buttom_img">
                <img
                  src="https://coaching.thimpress.com/business-consulting/wp-content/uploads/sites/52/2024/03/service-01.png"
                  alt="right_buttom_img"
                />
        ...
        <div className="services_carousel">
          <div className="carousel_wrap">
            <div className="carousel_images2">
              <img
                src="https://coaching.thimpress.com/business-consulting/wp-content/uploads/sites/52/2024/03/service-02.jpg"
                alt="carousel1"
              />
            </div>
            {/* <div className='carousel_images2' >
          ...
          <div className="text_carousels">
            ...
            <div className="text_images_items ">
              <div className="text_image_item ">
                <div className="text_item_line "></div>
          ...
          <div className="question_items_one">
            <div className="question_item" onClick={openClick}>
              <div className="question_item_top">
                ...
                <div>{open ? <HiMinus /> : <IoIosAdd />}</div>
              </div>
              <div className="quetion_line"></div>

              {open && (
                <p>
                  Lorem ipsum dolor sit amet consectetur. Netus cursus purus
                  faucibus blandit project discussion elit faucibus potenti cum
                  tempus non. Tortor id morbi velit mollis aliquet.
                </p>
              )}
            </div>
            <div className="question_item" onClick={openClick3}>
              <div className="question_item_top">
                ...
                <div>{open3 ? <HiMinus /> : <IoIosAdd />}</div>
              </div>
              <div className="quetion_line"></div>
              {open3 && (
                <p>
          ...
          <div className="question_items_two">
            <div className="question_item" onClick={openClick2}>
              <div className="question_item_top">
                ...
                <div>{open2 ? <HiMinus /> : <IoIosAdd />}</div>
              </div>
              <div className="quetion_line"></div>
              {open2 && (
                <p>
            ...
            <div className="question_item" onClick={openClick4}>
              <div className="question_item_top">
                ...
                <div>{open4 ? <HiMinus /> : <IoIosAdd />}</div>
              </div>
              <div className="quetion_line"></div>
              {open4 && (
                <p>
